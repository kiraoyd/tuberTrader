...
//         const {getIdTokenClaims, getAccessTokenSilently} = useAuth0(); //needs to be declared in a react component
//         const newToken = await getTokenFromAuth0(getAccessTokenSilently);
...
//
// //works, tested it
// //Note: getAccessTokenSilently can't be grabbed from the useAuth0 hook, here outside a react component
// export async function getTokenFromAuth0(getAccessTokenSilently) {
//
